"""
Django settings for p_crm_rapi project.
...
WSGI_APPLICATION = 'p_list_rapi.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        "a_list_rapi.permissions.GlobalViewPermission"
    ],
...
BROKER_URL = os.environ.get("DEFENDER_REDIS_URL", 'redis://localhost:6379/0')
CELERY_RESULT_BACKEND= os.environ.get("DEFENDER_REDIS_URL", 'redis://localhost:6379/0')
